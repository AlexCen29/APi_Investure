...
namespace Investure.Migrations
{
    ...
    public partial class NOMBRE_DE_LA_MIGRACION : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SeguimientoDeTareas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdEmpleado_fk = table.Column<int>(type: "int", nullable: false),
                    Tarea = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    FechaInicio = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaFin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Completada = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeguimientoDeTareas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeguimientoDeTareas_Empleado_IdEmpleado_fk",
                        column: x => x.IdEmpleado_fk,
                        principalTable: "Empleado",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeguimientoDeTareas_IdEmpleado_fk",
                table: "SeguimientoDeTareas",
                column: "IdEmpleado_fk");
        }
